                ...
                <div class="swiper-wrapper">
                  @foreach ($allImages as $img)
                    <div class="swiper-slide product-single__image-item">
                      <img loading="lazy" class="h-auto" src="{{ asset('storage/' . $img) }}" width="674"
                        height="674" alt="" />
                      <a data-fancybox="gallery" href="{{ asset('storage/' . $img) }}" data-bs-toggle="tooltip"
                ...
                <div class="swiper-wrapper">
                  @foreach ($allImages as $img)
                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                        src="{{ asset('storage/' . $img) }}" width="104" height="104" alt="" />
                    </div>
                  @endforeach
                </div>
              </div>
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__price">
            @if ($product->sale_price)
              <span class="current-price price-old">Rp {{ number_format($product->regular_price, 0, ',', '.') }}</span>
              <span class="current-price price-sale">Rp {{ number_format($product->sale_price, 0, ',', '.') }}</span>
            @else
              <span class="current-price">Rp {{ number_format($product->regular_price, 0, ',', '.') }}</span>
            @endif
          </div>
        ...
        <div class="swiper-container js-swiper-slider"
          ...
          <div class="swiper-wrapper">
              ...
              <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                  <a href="{{ route('shop-detail', $related->slug) }}">
                    <img loading="lazy" src="{{ asset('storage/' . $related->image) }}" width="330" height="400"
                      alt="{{ $related->name }}" class="pc__img">
                    @if ($related->images)
                      <img loading="lazy" src="{{ asset('storage/' . $related->images[0]) }}" width="330"
                ...
                <div class="pc__info position-relative">
                  ...
                  <h6 class="pc__title"><a href="{{ route('shop-detail', $related->slug) }}">{{ $related->name }}</a>
                  </h6>
                  <div class="product-card__price d-flex">
                    @if ($related->sale_price)
                      <span class="money price price-old">Rp
                        {{ number_format($related->regular_price, 0, ',', '.') }}</span>
            ...
            {{-- <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_1.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_1-1.jpg') }}" width="330"
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_2.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_2-1.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                </a>
                <button
                  class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside"
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_6.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_6-1.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                </a>
                <button
                  class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside"
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_7.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_7-1.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                </a>
                <button
                  class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside"
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_4.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_4-1.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                </a>
                <button
                  class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside"
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_5.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_5-1.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                </a>
                <button
                  class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside"
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_8.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                  <img loading="lazy" src="{{ asset('assets/images/products/product_8-1.jpg') }}" width="330"
                    height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                </a>
                <button
                  class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside"
