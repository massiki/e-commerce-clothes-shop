    ...
    <div class="main-content-wrap">
      ...
      <div class="wg-box">
        <form class="form-new-product form-style-1" method="POST"
          ...
          <fieldset>
            ...
            <div class="upload-image flex-grow">
              <div class="item" id="imgpreview"
                style="display:{{ $slider->image || old('image') || $errors->has('image') ? 'block' : 'none' }}">
                @php
                  $imageSrc = old('image') ? '' : ($slider->image ? asset('storage/' . $slider->image) : '');
                @endphp
                <img src="{{ $imageSrc }}" class="effect8" alt="" id="preview-image">
              </div>
          ...
          <div class="bot">
            <div></div>
            <button type="submit" class="tf-button w208">Update</button>
          </div>
        </form>
      </div>
      <!-- /edit-category -->
