...
@section('content')
  <main>
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      {{-- show 2 cheap product --}}
      <section class="category-banner container">
        <div class="row">
          @foreach ($cheapProducts as $product)
            <div class="col-md-6">
              <div class="category-banner__item border-radius-10 mb-5">
                <img loading="lazy" class="h-auto" src="{{ asset('storage/' . $product->image) }}" width="690"
                  height="665" alt="{{ $product->name }}" />
                <div class="category-banner__item-mark">
                  Starting from Rp {{ number_format($product->regular_price, 0, ',', '.') }}
                </div>
