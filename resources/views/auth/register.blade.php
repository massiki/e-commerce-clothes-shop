          ...
          <div class="register-form">
            <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation"
              ...
              <div class="form-floating mb-3">
                <input class="form-control form-control_gray @error('name') is-invalid @enderror" id="name"
              ...
              <div class="form-floating mb-3">
                <input id="telephone" type="text"
                  class="form-control form-control_gray @error('telephone') is-invalid @enderror" name="telephone"
